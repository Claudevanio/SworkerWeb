...
export const ModalEsqueciSenha = ({
  isOpen,
  onClose
}: {
  isOpen: boolean;
      ...
      >
        <Form onSubmit={(data) => onSubmit(data as FormFields)}
          ...
          >
            ...
            { step === 2 && 'Enviamos um código de recuperação para o seu e-mail cadastrado. Por favor, verifique a sua caixa de entrada e a pasta de spam, se necessário.'}
          ...
          <div
           ...
           step === 1 &&
            ...
            <Button
              type="submit" 
            >
              {step === 1 ? 'Enviar' : step === 5 ? 'Fechar' : 'Próximo'} 
            </Button>
            </div>
          </Form>
