...
export function OcurrenceList({
  ...
  return(
    <div> 
      ...
      >
        <div
          className='p-6 rounded-lg border-primary-100 border-2 flex flex-col gap-6'
        >
          <div
          ...
          > 
            ...
            <div>
              <p
                className='text-primary-600 text-[3rem] font-bold'
              >
                {geradas.count}
              </p>
              <p
                className='text-primary-500 text-base font-semibold mt-[-10px]'
              >
                Geradas
              </p>
            </div> 
