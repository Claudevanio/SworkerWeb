      ...
      <Form onSubmit={data => onSubmit(data as FormFields)} className="flex flex-col gap-4 pb-4" {...methods}>
        <div className="flex gap-4 md:gap-6 flex-col md:flex-row ">
          ...
          <div className="w-full md:w-1/2">
            <Input name="version" label="Versão" required placeholder="Versão" error={methods.formState.errors.version} disabled={readonly} />
          </div>
        </div>
        <div className="flex gap-4 md:grid md:grid-cols-2 flex-col md:flex-row justify-between">
