...
export function CompanyTab() {
  ...
  return (
    <>
      ...
      />
      <Pagination
        currentPage={companies?.filters?.page ?? 1}
        totalPages={Math.ceil(companies?.data?.count / companies?.filters?.pageSize)}
        onChange={page =>
          companies.setFilter(prev => ({
            ...prev,
            page
