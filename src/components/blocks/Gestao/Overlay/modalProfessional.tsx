  ...
  return (
    ...
    >
       <Form onSubmit={(data) => onSubmit(data as FormFields)}
            className='flex flex-col gap-4 pb-4 relative'
            {...methods}
      > 
        <div
        ...
        <div
          style={{ 
                  ...
                  >
                    ...
                    >
                      ...
                      <CheckBox
                        label=''
                        value={
                          unitsIds && unitsIds.includes(sector.id)
                        }
                        onChange={
                          () => {
                            if(!unitsIds)
                            ...
                            if(unitsIds?.includes(sector.id)){
                              methods.setValue('unitsIds', unitsIds.filter(id => id !== sector.id))
                            } else {
            ...
            {
              methods.formState.errors.unitsIds && (
                <span
                  className='text-danger text-xs'
                >
                  {methods.formState.errors.unitsIds.message}
                </span>
              )
            }
        </div>
