...
export function ModalEquipmentsHistory({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={'Histórico'} width="800px">
      <div className="flex flex-col pt-4">
        <h1 className="text-[1.25rem] font-medium text-base-7">Histórico de atribuições</h1>
        <BaseTable
          columns={[
            {
      ...
      <div className="flex flex-col pt-4">
        <h1 className="text-[1.25rem] font-medium text-base-7">Histórico de inspeções</h1>
        <BaseTable
          columns={[
            {
              key: 'inspectionDate',
