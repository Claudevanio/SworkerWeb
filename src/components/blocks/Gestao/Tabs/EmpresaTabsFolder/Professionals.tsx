...
export function ProfessionalTab() {
  ...
  return (
    <>
      ...
      />
      <Pagination
        currentPage={professionals?.filters?.page ?? 1}
        totalPages={Math.ceil(professionals?.data?.count / professionals?.filters?.pageSize)}
        onChange={page =>
          professionals.setFilter(prev => ({
            ...prev,
            page
