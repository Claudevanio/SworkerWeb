...
export function ServicosOperacionaisComponent() {
  ...
  const tabs = [
    { label: 'Kanban', icon: <ViewKanban className="text-primary-500" /> },
    { label: 'Evolução', icon: <Moving className="text-primary-500" /> }
  ];
