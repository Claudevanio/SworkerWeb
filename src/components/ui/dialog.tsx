...
export const Dialog = ({ title, isOpen, onClose, children, width = '444px', fullMobile = false, onSubmit, SubmitText }: DialogProps) => {
  const style = {
    position: 'absolute',
    top: '50%',
    left: '50%',
      ...
      <>
        <Box sx={style}>
          <div className="flex justify-between items-center w-full mb-2">
            <h2 className="text-base-8 font-bold text-base ">{title}</h2>
