...
export function BaseTable({ rows, columns, actions, onExpand, onClickRow, isLoading }: CustomizedTableProps) {
      ...
      borderSpacing: '0px 16px' 
        ...
        <TableBody>
          ...
          {!isLoading && rows.length > 0 && rows.map((row) => (
            ...
            >
               {desktopColumns.map((column) => (
                  <StyledTableCell align="left" key={column.key} component="td"
                    style={column.style}
                  >
