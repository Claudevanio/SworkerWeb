...
export const DynamicInputField: React.FC<DynamicInputFieldProps> = ({
  individualLabel,
  name,
  label,
  maxInputs,
...
export const DynamicFileUploadField: React.FC<FileUploadProps> = ({ label, maxInputs, required, type, name }) => {
              ...
              <OutlinedInput
                ...
                startAdornment={
                  <InputAdornment position="start" className="flex items-center">
                    <AttachFileIcon />
                    <span className="font-semibold text-black ml-2 pr-14 sm:border-r-2">Arquivo</span>
