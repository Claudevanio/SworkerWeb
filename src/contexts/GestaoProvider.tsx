...
export const GestaoProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const {
    ...
    data: companyUnities,
    refetch: refetchCompanyUnits
  } = useQuery<basePagination<ICompanyUnity> | undefined>({
    queryKey: ['searchCompanyUnities', companyUnityQueryObject, currentCompany?.id],
    queryFn: () =>
      companyUnityService.listUnitiesByCompanyAsync({
  ...
  } = useQuery<basePagination<IProfessional> | undefined>({
    queryKey: ['searchProfessionals', professionalQueryObject, currentCompany?.id],
    queryFn: () =>
      professionalService.listProfessionalAsync({
  ...
  const {
    ...
    queryFn: () =>
      equipmentService.getEquipmentsByCompanyAsync({
